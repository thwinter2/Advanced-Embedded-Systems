...
#define SERVO_TILT_MAX  145    //The upper servo's max degree
#define SERVO_TILT_MIN  15     //The upper servo's min degree
#define SERVO_PAN_MAX  180  //The lower servo's max degree
#define SERVO_PAN_MIN  0        //The lower servo's min degree
#define STEP  2              //The step value
#define STEP_DELAY   2        //Delay time(ms) every step
#define SERVO_TILT_CH  0       //The upper servo Channel
#define SERVO_PAN_CH  1     //The lower servo Channel
...
extern uint8_t ServoPanDegree;
  ...
  void Update_Servo(int error_x, int error_y);// New - AGD
